"""
Django settings for lab5_rds project.
...
WSGI_APPLICATION = 'lab5_rds.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static', os.path.join(frontend_dir, 'static')]
